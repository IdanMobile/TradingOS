...
| RG-07 | PBO/DSR implementation details vs primary papers (estimator choices, small-sample behavior) | G10 gate correctness | papers identified [S]; `G10_RETENTION` evidence retained; method fixtures pass; candidate-specific PBO/CSCV+DSR with independent recomputation DONE 2026-07-11 (`artifacts/validation/G10_CANDIDATE_EVIDENCE_2026_07_11.json`, all families FAIL) — production G10 active | none for FAIL claims; stats-specialist review before honoring any future G10 PASS | validation stats specialist | closed for production activation; PASS-claim review gate remains | blocks full validation/promotion, not offline research | R4/R7 | before any G10 PASS claim |
