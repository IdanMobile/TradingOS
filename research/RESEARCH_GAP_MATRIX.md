...
| RG-07 | PBO/DSR implementation details vs primary papers (estimator choices, small-sample behavior) | G10 gate correctness | corrected v2 candidate-specific PBO/CSCV+DSR independently recomputes (`artifacts/validation/G10_CANDIDATE_EVIDENCE_2026_07_13.json`): B2/B4 numerically FAIL, B3 is method-blocked | complete upstream search hierarchy, hierarchy-wide dependence/effective trials, and stats-specialist review before honoring any future G10 PASS | validation stats specialist | `METHOD_BLOCKED`; corrected family diagnostics retained | blocks full validation/promotion, not offline research | R4/R7 | before any G10 PASS claim |
