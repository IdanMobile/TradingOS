...
| vectorbt (OSS) | **v1.1.0 (2026-07-05)** — OSS line REACTIVATED 2026 (v1.0.0 Apr 2026) [S] | active again; pandas 3 / py3.14 / NumPy 2.4 stack [S] | NOASSERTION on GitHub; community-reported Apache-2.0 + Commons Clause [M → RG-03] | vectorized sweeps, research acceleration | no live/paper; multiple-testing hazard; new dep-stack (pandas 3) may conflict with other engines | ACCELERATOR PROBE — **assumption "OSS abandoned, PRO required" is now FALSE**; probe OSS first |
