"""Freeze and selection-barrier checks for the Spot taker-imbalance campaign."""
...
from run_btc_spot_taker_imbalance_campaign import (  # noqa: E402
    CAMPAIGN,
    OUTPUT_ROOT,
...
def test_taker_campaign_contract_is_frozen_safe_and_complete() -> None:
    ...
    assert campaign["gates"]["required_positive_periods_of_7"] == 5
    if OUTPUT_ROOT.exists():
        assert len(list(OUTPUT_ROOT.glob("campaign_result_*.json"))) == 1


def test_taker_reserve_cannot_run_without_hashed_selection() -> None:
