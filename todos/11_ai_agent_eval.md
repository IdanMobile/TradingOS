...
- Acceptance: registry round-trip tests; provider policy fields populated from REG §7. Complexity: M. Status: **DONE 2026-07-07**.
...
- Acceptance: corpus hash manifest; leakage-control checklist per suite spec satisfied. Complexity: L. Status: **DONE 2026-07-07**.
...
- Acceptance: end-to-end null run green; no-network controlled-mode enforcement test. Complexity: L. Dependencies: T-011-01/02. Status: **DONE 2026-07-07**.
...
- Human approval: **Yes (operator reviews samples)**. Acceptance: calibration set frozen + hashed. Complexity: M. Status: **DONE 2026-07-07** for the frozen set; human review remains PENDING in the artifact.
