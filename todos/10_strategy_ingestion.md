...
- Acceptance: lifecycle transition guards tested; license-class gating works. Complexity: M. Dependencies: T-005-01. Status: TODO.
...
- Acceptance per item: validator verdict recorded; ambiguities non-empty or justified; license evidence linked. Failure: any profit-claim import. Complexity: M each. Status: TODO ×10.
...
- Acceptance: report answers the five completion-report questions in the seed spec. Complexity: S. Dependencies: all items. Status: TODO.
