...
- Acceptance: METHOD_VALIDATED verdict or explicit deferral record. Complexity: L. Parallelizable: Yes. Status: **DONE 2026-07-11 — PRODUCTION G10 ACTIVE, CANDIDATE VERDICT FAIL** — method fixtures pass (`G10_METHOD_FIXTURES_2026_07_11.json`), and candidate-specific PBO/CSCV+DSR now runs on the retained B2/B3/B4 trial populations with exact parity checks against the retained Parquet and an independent second implementation (erf-CDF/bisection/two-pass variance, agreement ≤1e-9 PBO / ≤1e-6 DSR). All families FAIL (B2 PBO 0.8685, DSR≈0). Evidence: `artifacts/validation/G10_CANDIDATE_EVIDENCE_2026_07_11.json`, `scripts/run_g10_candidate.py`, `engines/vectorbt/g10_returns.py`, `tests/test_g10_candidate.py`. The B2 package gate G10 is FAIL; any future G10 PASS still requires validation-stats-specialist review before promotion use (RG-07 reverify rule).
