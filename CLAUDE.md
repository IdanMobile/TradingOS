...
For trading-system research, strategy evaluation, architecture review, data or backtest validation, risk review, and project supervision, use the project skill `/trading-os-supervisor`.
