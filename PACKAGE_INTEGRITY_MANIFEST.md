...
Package version: v8.150 operator control center — START_MULTI + START_RESEARCH audited spawns, read-only report views; research guard hardened (2026-07-26). Supersedes v8.149 hashes.
...
| `DECISION_LOG.md` | `154884676aea120042111bd79e687e8e573ee44209e65309c2ea91a42649bb7d` |
...
| `src/tios/services/dashboard_ui/server.py` | `41906fbd943bc438296072ad58184a59539cf7c99f8dd40d224032da891831ea` |
| `src/tios/services/dashboard_ui/dashboard.html` | `e4db68fbf4a57b7785a21b66227ed83b9bee679a156e5d9049df70d216254b41` |
| `tests/test_dashboard.py` | `3f82bfaeae2f456517048144a6a16e66b1c4b5f89ae5cb02ec56246d61676ca1` |
...
| `engines/reference/taker_imbalance.py` | `f4da8b1f6c8d8ad82704f7e7a231bde6d9a49cccfe443ca80ebfcf9206207262` |
...
| `scripts/run_btc_spot_taker_imbalance_campaign.py` | `9e78c3ce86e591665b5e522ed71ba0155c92858eaca56c272cb09163a54b074e` |
| `tests/test_taker_imbalance_strategy.py` | `55292b75c86cb98458437c07646846a256d6d70f93f75427e3a2a9caa04d33df` |
| `tests/test_taker_imbalance_reference.py` | `78dc0ef201c785f146c5ae75328e0eed06febc2c2f2e1458ac6641317640aaea` |
| `tests/test_taker_imbalance_campaign.py` | `bb44a26e73ba283ca18c9e35079553b22581cc9d6165677d14c0784086d472aa` |

## Spot taker-imbalance V1 abort and V2 freeze (added v8.76)
...
## Public-signal research boundary NO_GO (added v8.82)

| Path | SHA-256 |
|---|---|
| `research/STRATEGY_FAMILY_SELECTION_AND_PREREGISTRATION_V9.md` | `31f6fcfffc20ba589578dca4b65306a9f1ae1f96ec8068bc4c897f1f3397cdb2` |

## Prospective liquidation-stress signal freeze (added v8.83)
...
| Path | SHA-256 |
|---|---|
| `artifacts/reports/PROSPECTIVE_BTC_LIQUIDATION_STRESS_FIRST_SESSION_2026_07_13.md` | `45b5ac68da7e09fa711a0110fd9379f78437b47593951ea4d3d11795ec07ba42` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/raw/exchange_info_07a0858c96751c863d3222c70715523a27fa42396d5773171a0025d9d6b1d723.json` | `07a0858c96751c863d3222c70715523a27fa42396d5773171a0025d9d6b1d723` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/session_4638af9e36fa9f34bd800dbc3057f883f3336c04bde50aab2936ff707af6c685.json` | `4638af9e36fa9f34bd800dbc3057f883f3336c04bde50aab2936ff707af6c685` |

## Complete-window prospective observer V2 freeze (added v8.85)
...
| Path | SHA-256 |
|---|---|
| `artifacts/reports/PROSPECTIVE_BTC_LIQUIDATION_STRESS_FIRST_COMPLETE_WINDOW_2026_07_13.md` | `3db5f4ac2e2cea656d7dc0b31eafe302602d6e5724d1e97bf1423c6c100a0c9a` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/session_2f582162f4296e41d9d85f93db5dfa9e4a42d6f25fc2d06a9253abb50891d810.json` | `2f582162f4296e41d9d85f93db5dfa9e4a42d6f25fc2d06a9253abb50891d810` |

## Prospective causal Spot label freeze (added v8.87)
...
## Observer V4 complete-window proof (added v8.94)
...
## Persistent checkpoint operations contract (added v8.96)
...
| `tests/test_prospective_liquidation_observer.py` | `c6c52a47aa9fac5b5307f02443e91865feb07fa3cd090767534b910185bee0a5` |
| `tests/test_prospective_liquidation_checkpoints.py` | `086be8a14c4f89bd926eb47e3faeb1edfbe609a5e5145f022441b55eed51a3aa` |

## V5 two-window public proof (added v8.98)
...
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/session_bf68af8b6b728a0b1b890472e1797a62b8a43fbb7c4e2a5fb2c4f8e1636ab40c.json` | `bf68af8b6b728a0b1b890472e1797a62b8a43fbb7c4e2a5fb2c4f8e1636ab40c` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/session_e9daa3ac1539ba58b1d6978574ad1ab4c436673b8c3c9ae72ca605e2a7adbb16.json` | `e9daa3ac1539ba58b1d6978574ad1ab4c436673b8c3c9ae72ca605e2a7adbb16` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/labels/raw/kline_305f7ac3a4fdb5b49aa4e8280928bd880a4e866fceb83540dc06b9f86ea13f48.json` | `305f7ac3a4fdb5b49aa4e8280928bd880a4e866fceb83540dc06b9f86ea13f48` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/labels/raw/kline_5491d26f776f1fd49cf54b045cbca3ee910db57b87f5723d80b141c43148e28b.json` | `5491d26f776f1fd49cf54b045cbca3ee910db57b87f5723d80b141c43148e28b` |
...
## Managed observation implementation freeze (added v8.100)
...
| Path | SHA-256 |
|---|---|
| `artifacts/reports/PROSPECTIVE_OBSERVATION_MANAGED_ADOPTION_2026_07_14.md` | `f926d3058f240d274d61ceef283d335d33008a8c6d7b005324c59fc25d1cc463` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/operations/intents/intent_ee043ada0ec765d75152f77e1cbf49fb42a6bdd6a7062e020e5f4dfde9abbc8d.json` | `ee043ada0ec765d75152f77e1cbf49fb42a6bdd6a7062e020e5f4dfde9abbc8d` |
...
## Append-only label verifier V2 freeze (added v8.89)
...
| Path | SHA-256 |
|---|---|
| `artifacts/reports/PROSPECTIVE_BTC_LIQUIDATION_SECOND_COMPLETE_WINDOW_2026_07_13.md` | `0c49e268b2fd558fe1a4150c9b346e3e94e9aa2e3a8fbf89b97bad49c142d991` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/raw/exchange_info_0ee97fb812053b261722db5dab79b3488f75743ace6e9656597156351eae634a.json` | `0ee97fb812053b261722db5dab79b3488f75743ace6e9656597156351eae634a` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/session_f1655057e707798e3d142157bdc5eb09028c25b4e89afe113c3e4f04f499f7f1.json` | `f1655057e707798e3d142157bdc5eb09028c25b4e89afe113c3e4f04f499f7f1` |
| `artifacts/prospective/BTC-LIQUIDATION-STRESS-V1/labels/label_snapshot_f5453680fd3b6fbac1b86f705691da0ebde51a2e252ecea48bd169d7db3a3ccd.json` | `f5453680fd3b6fbac1b86f705691da0ebde51a2e252ecea48bd169d7db3a3ccd` |

## Fail-closed continuity evidence and observer V3 freeze (added v8.91)
...
## Live schema diagnosis and observer V4 freeze (added v8.92)
